...
| --- | --- | --- | --- |
| 1 | API key | `POST /v1/auth/signup` → `POST /v1/api-keys` | `api_key` |
...
## All resources (Postman folders)

| Resource | Guide | When |
| --- | --- | --- |
| Auth | [Sign up](/api-reference/auth/sign-up) | Once |
| API Keys | [Create key](/api-reference/api-keys/create-api-key) | Once |
